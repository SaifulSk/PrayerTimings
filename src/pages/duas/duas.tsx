    ...
    <React.Fragment>
      ...
      <section className="main-container">
        ...
        <div className="mb-3">
          <SelectInput
            onChange={changeType}
            options={["masnoon", "ramadan", "rabbana"].map((x: any) => {
              return {
        ...
        {data ? (
          Object.keys(data).map((item: any) => (
            <>
              ...
              <div className="zikr-wrap">
                <div className="zikr-img">{data[item].arabic}</div>
                <div className="zikr-meaning text-white">
              ...
              {data[item]["recommended-use"] && (
                <div className="desc-text">
                  Recommended Use:{data[item]["recommended-use"]}
                </div>
              )}
            </>
          ))
